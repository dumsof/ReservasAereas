...
namespace ReservasAereas.Controllers
{
    public class TiposDocumentosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdTipoDocumento,DecripcionTipoDocumento")] TiposDocumentos tiposDocumentos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdTipoDocumento,DecripcionTipoDocumento")] TiposDocumentos tiposDocumentos)
        {
            if (ModelState.IsValid)
            {
